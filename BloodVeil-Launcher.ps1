# BloodVeil Public V1.3 Beta - Client Launcher
# Downloads client and cache from this repo's GitHub releases

# Configuration — update RELEASE_TAG when you publish a new release
$RELEASE_TAG = "v1.3.0"
...
# Set window title
$Host.UI.RawUI.WindowTitle = "BloodVeil V1.3 Beta - Launcher"

# Display header
Write-Host ""
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "   BloodVeil Public V1.3 Beta" -ForegroundColor Yellow
